package com.nasa.projectnasa.common.jwt;
...
public class JwtTokenProvider {
  ...
  public AccountResponse.TokenInfo generateToken(Authentication authentication) {
    return generateToken(authentication.getName(), authentication.getAuthorities());
  }

  //name, authorities 를 가지고 AccessToken, RefreshToken 을 생성하는 메서드
  public AccountResponse.TokenInfo generateToken(String name, Collection<? extends GrantedAuthority> inputAuthorities) {
    //권한 가져오기
    ...
    return AccountResponse.TokenInfo.builder()
